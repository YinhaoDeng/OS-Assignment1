...
int find_the_most_prior_customer(vector<Customer*> vec)  // queue1 use
{
    ...
    {
        // cout<<"I reset if_check flag!"<<endl;
...
{
    // cout<<"q "<<q<<endl;
    int most_prior_customer_idx = find_the_most_prior_customer(customer_vec); // push the customer with highest priority into the queue1
